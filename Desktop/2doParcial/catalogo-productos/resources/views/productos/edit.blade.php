...
<div class="max-w-xl mx-auto">
    <div class="mb-4"><a href="{{ route('productos.index') }}" class="text-xs text-slate-400 hover:text-white">← Cancelar y salir</a></div>
    <h1 class="text-xl font-bold text-white mb-6">Modificar Producto</h1>
    ...
    <div class="bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <form action="{{ route('productos.update', $producto) }}" method="POST">
            ...
            @method('PUT') <div class="mb-4">
                ...
                <input type="text" name="nombre" value="{{ old('nombre', $producto->nombre) }}" class="w-full bg-slate-950 p-2.5 rounded-xl border border-slate-800 focus:outline-none focus:border-amber-400 text-sm">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="sku" value="{{ old('sku', $producto->sku) }}" class="w-full bg-slate-950 p-2.5 rounded-xl border border-slate-800 focus:outline-none focus:border-amber-400 text-sm">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" name="precio" step="0.01" value="{{ old('precio', $producto->precio) }}" class="w-full bg-slate-950 p-2.5 rounded-xl border border-slate-800 focus:outline-none focus:border-amber-400 text-sm">
                ...
                <div>
                    ...
                    <input type="number" name="stock" value="{{ old('stock', $producto->stock) }}" class="w-full bg-slate-950 p-2.5 rounded-xl border border-slate-800 focus:outline-none focus:border-amber-400 text-sm">
