                    ...
                    <form method="POST" action="{{ route('sitios.update', $sitio) }}">
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="titulo" name="titulo" class="block mt-1 w-full pl-10 pr-4 py-3 border-gray-200 rounded-xl focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-all duration-200" :value="old('titulo', $sitio->titulo)" required />
                            </div>
                        ...
                        <div class="mt-6 group">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="url" name="url" type="url" class="block mt-1 w-full pl-10 pr-4 py-3 border-gray-200 rounded-xl focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-all duration-200" :value="old('url', $sitio->url)" required />
                            </div>
                            ...
                            <div class="relative">
                                <select id="categoria" name="categoria" 
                                    ...
                                    @foreach (['Educación','Herramientas','Noticias','Entretenimiento','Redes sociales','Otros'] as $cat)
                                        <option value="{{ $cat }}" @selected(old('categoria', $sitio->categoria) === $cat)>{{ $cat }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="descripcion" name="descripcion"
                                ...
                                rows="3">{{ old('descripcion', $sitio->descripcion) }}</textarea>
                        ...
                        <div class="mt-6 flex items-center gap-3 p-3 bg-purple-50/50 rounded-xl border border-purple-100 transition-all hover:bg-purple-50">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input id="destacado" name="destacado" type="checkbox" value="1" @checked(old('destacado', $sitio->destacado)) class="sr-only peer">
